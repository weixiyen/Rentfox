...
_magic_number = 5
_modified_time = 1248197038.4530001
_template_filename='C:\\fox\\rentfox\\rentfox\\templates/derived/floorplan/new.html'
_template_uri='/derived/floorplan/new.html'
...
def render_heading(context):
    ...
    try:
        ...
        __M_writer = context.writer()
        # SOURCE LINE 4
        __M_writer(u'\n    <div id="pageTitle">Add a new floorplan</div>\n')
        return ''
    finally:
        context.caller_stack._pop_frame()
