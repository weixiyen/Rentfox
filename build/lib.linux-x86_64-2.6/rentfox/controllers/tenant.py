...
class TenantController(BaseController):
    ...
    def create(self, fname=None, lname=None, email=None, phone=None, dob=None, ssn=None, leaseId=None):
        ...
        redirect_to(controller='tenant', action='json', id=tenant_id)
    ...
    def updateTenant(self):
        ...
        model.Tenant.update(
                            ...
                            dob=dob,
                            ssn=ssn)
        redirect_to(controller='tenant', action='json', id=tenantid)
    ...
    def saveResidence(self):
        ...
        landlordname = request.POST['landlordname']
        landlordphone = request.POST['landlordphone']
        landlordemail = request.POST['landlordemail']
